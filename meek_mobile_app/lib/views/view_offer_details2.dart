...
import '../addbid1.dart';
import '../addbidinnovator.dart';
import '../constans.dart';

String UserIDD;
class calendarPage2 extends StatefulWidget {
  calendarPage2({this.UserId});
  final String UserId;
  @override
                ...
                Expanded(
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text("PitchID: ${userData[index]["pitchId"]}", style: TextStyle(
                            color: Colors.black,
...
//                    Icon(Icons.timer, color: Colors.lightBlueAccent,),
                            ...
                            Column(
                              children: [
                                Text("Message from innovator: ${userData[index]["InnovatorMessage"]}", style: TextStyle(
                        ...
                        Row(
                          children: [
                            ...
                            Text(" ${userData[index]["Innovatorfunds"]}", style: TextStyle(
                                color: Colors.black,
                                fontSize: 16,
                                fontWeight: FontWeight.w600
                            ),)
                        ...
                        Row(
                          children: [
                            ...
                            Text(" ${userData[index]["Innovatorpercentage"]}%", style: TextStyle(
                                color: Colors.blue,
                                fontSize: 16,
                                fontWeight: FontWeight.w600
                            ),)
...
//
                                  FlatButton.icon(onPressed: () {
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(builder: (context) => AddBid2()),
                                    );
                                  }, icon: Icon(FontAwesomeIcons.undoAlt,color: Colors.green,) , label: Text("Counter bid", style: TextStyle(
                                      color: Colors.green,
                                      fontSize: 15,
                                      fontWeight: FontWeight.w600
                                  ),),)

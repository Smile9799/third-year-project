...
String UserIDD;
class TrackNew2 extends StatefulWidget {
  TrackNew2({this.UserId});
  final String UserId;
  @override
  TrackNew2State createState() => TrackNew2State();
}

class TrackNew2State extends State<TrackNew2> {
...
//
                                      FlatButton.icon(onPressed: () {
                                        Navigator.push(
                                          context,
                                          MaterialPageRoute(builder: (context) => ViewPitchPage2()),
                                        );
